...
def write_couplings(doc, cycles, bolsas, peptides, simple, doble, triple, desprotection):
    ...
    for i, (aa_positions, ending, active) in enumerate(cycles):
        ...
        widths = [Mm(90), Mm(30), Mm(30), Mm(45)]
        ...
        row[1].text = "CHEQUEO"
        row[2].text = "HECHO POR"
        row[3].text = "REVISADO POR"
...
#    format_cell(cell)
        ...
        def add_row2(text):
            ...
            row_cells[0].text = text
            row_cells[1].text = "|___:___||___:___|"
            row_cells[2].text = "__________________"
            row_cells[3].text = "_________________"
        ...
        if ending:
            p = doc.add_paragraph()
            run = p.add_run("Finalizan bolsas: " + ", ".join(map(str, ending)))
            run.bold = True
            run.underline = True
...
#	#	#*#############################################################################################
#	#	#*##################-----EVALUANDO  030526------#######################################################
#	#	# === TABLA INVISIBLE PARA DESPROTECCIÓN Y ACOPLE ===
#	#	        table = doc.add_table(rows=1, cols=4)
#	#	        table.autofit = True	#False
#	#	        
#	#	        # Anchos fijos (ajústalos si quieres)
#	#	        widths = [Mm(90), Mm(30), Mm(30), Mm(45)]
#	#	        for i, w in enumerate(widths):
#	#	            table.columns[i].width = w
#	#	        
#	#	        # Quitar bordes (tabla invisible)
#	#	        for row in table.rows:
#	#	            for cell in row.cells:
#	#	                tc = cell._element
#	#	                tcPr = tc.get_or_add_tcPr()
...
#	#	                tcPr.append(tcBorders)
#	#	        
#	#	        # === HEADER DESPROTECCIÓN ===
#	#	        row = table.rows[0].cells
#	#	        row[0].paragraphs[0].add_run("DESPROTECCIÓN").bold = True
#	#	        row[1].paragraphs[0].add_run("CHEQUEO").bold = True
#	#	        row[2].paragraphs[0].add_run("HECHO POR").bold = True
#	#	        row[3].paragraphs[0].add_run("REVISADO POR").bold = True
#	#	        
#	#	        # Helper para agregar filas
#	#	        def add_row(text, check):
#	#	            row_cells = table.add_row().cells
#	#	            row_cells[0].paragraphs[0].add_run(text)
#	#	            row_cells[1].paragraphs[0].add_run(check)
#	#	            row_cells[2].paragraphs[0].add_run("_________________")
#	#	            row_cells[3].paragraphs[0].add_run("_________________")
#	#	            # SE AGREGA ESTO:
#	#	            for cell in row_cells:
#	#	                for paragraph in cell.paragraphs:
#	#	                    # 1.0 = Espaciado sencillo, 1.1 = Un poco más de aire
#	#	                    paragraph.paragraph_format.line_spacing = 1.5 
#	#	                    # Quita el espacio automático de Word después del párrafo
#	#	          #          paragraph.paragraph_format.space_after = Pt(0) 
#	#	                    for run in paragraph.runs:
#	#	                        run.font.name = 'Cambria'
#	#	                        run.font.size = Pt(9)
#	#	        
#	#	        # === CONTENIDO DESPROTECCIÓN ===
#	#	        add_row(f"{desprotection} (2x10') ♻️", "|_____|_____|")
#	#	        add_row("Lavado con DMF (3x1') ♻️", "|___|___|___|")
#	#	        add_row("Lavado con IPA (1x1')", "|___________|")
#	#	        add_row("Lavado con BPB 1% en DMF (1x2')", "|___________|")
...
#	#	        # Header
#	#	        row = table2.rows[0].cells
#	#	        row[0].paragraphs[0].add_run("CICLO DE ACOPLE").bold = True
#	#	        row[1].paragraphs[0].add_run("HORA").bold = True
#	#	        row[2].paragraphs[0].add_run("HECHO POR").bold = True
#	#	        row[3].paragraphs[0].add_run("REVISADO POR").bold = True
#	#	        
#	#	        # SE AGREGA ESTO:
...
#	#	                    run.font.size = Pt(9)
#	#	        
#	#	        def add_row2(text, extra):
#	#	            row_cells = table2.add_row().cells
#	#	            row_cells[0].paragraphs[0].add_run(text)
#	#	            row_cells[1].paragraphs[0].add_run("|___:___||___:___|")
#	#	            row_cells[2].paragraphs[0].add_run("__________________")
#	#	            row_cells[3].paragraphs[0].add_run("_________________")
#	#	        
#	#	        # === CONTENIDO ACOPLE ===
#	#	        add_row2("Simple", "")
#	#	        table2.add_row().cells[0].paragraphs[0].add_run(simple)
#	#	        add_row2("Doble ♻️", "")
#	#	        table2.add_row().cells[0].paragraphs[0].add_run(doble)
#	#	        add_row2("Triple ♻️", "")
#	#	        table2.add_row().cells[0].paragraphs[0].add_run(triple)
#	#	
#	#	
#	#	
